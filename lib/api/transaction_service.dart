...
class TransactionService {
  Future<bool> placeOrder(List<TransactionProductModel> transactionProduct) async {
    ...
    var httpBody = jsonEncode({
      ...
      "id_order_type": 1,
      "table": table,
      "products": transactionProduct.map((e) => {
    ...
    var response = await http.post(Uri.parse(url), headers: httpHeaders, body: httpBody);

    return (response.statusCode == 200) ? true : throw Exception("Cannot place order, please try again");
  }
}
